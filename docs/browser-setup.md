...
This guide covers setting up browser automation capabilities in CclawCore, including both headless automation and GUI access via VNC.

## Overview

CclawCore supports multiple browser access methods:
...
```bash
echo "Open https://example.com and tell me what it says" | cclawcore agent
```
...
### CclawCore Integration Tests

```bash
# Content extraction
echo "Open https://example.com and summarize it" | cclawcore agent

# Navigation
echo "Go to https://github.com/trending and list the top 3 repos" | cclawcore agent

# Form interaction
echo "Go to Wikipedia, search for 'Rust programming language', and summarize" | cclawcore agent
```
...
- [CclawCore Configuration Reference](./config-reference.md)

...
## Problem
CclawCore logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/cclawcore/audit.key"
...
cclawcore audit --user @alice

# Show all high-risk commands
cclawcore audit --risk high

# Show violations from last 24 hours
cclawcore audit --since 24h --violations-only

# Export to JSON for analysis
cclawcore audit --format json --output audit.json

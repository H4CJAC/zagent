...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `cclawcore onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `cclawcore onboard` |
| Config exists, just fix channels | `cclawcore onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `cclawcore onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `cclawcore onboard --api-key "sk-..." --provider openrouter`
- Guided onboarding: `cclawcore onboard`
...
- Validate environment: `cclawcore status` + `cclawcore doctor`

# CclawCore Contributor License Agreement (CLA)
...
property rights granted by contributors to CclawCore Labs. This agreement
protects both contributors and users of the CclawCore project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the CclawCore repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to CclawCore Labs
  for inclusion in the CclawCore project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"CclawCore Labs"** means the maintainers and organization responsible
  for the CclawCore project at https://github.com/cclawcore-labs/cclawcore.

---

## 2. Grant of Copyright License

You grant CclawCore Labs and recipients of software distributed by CclawCore
...
the CclawCore project.

**This protects you:** if a third party files a patent claim against
CclawCore that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to CclawCore
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with CclawCore Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the CclawCore name,
...
CclawCore Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the CclawCore project are licensed under
both:
...
By opening a pull request or submitting a patch to the CclawCore repository,
...
https://github.com/cclawcore-labs/cclawcore/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the CclawCore dual-license model.*

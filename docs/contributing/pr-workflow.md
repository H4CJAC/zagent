# CclawCore PR Workflow (High-Volume Collaboration)

This document defines how CclawCore handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to CclawCore/project-native labels.
...
- Confirm any required identity-like wording uses CclawCore/project-native terminology.

...
Rules for pull request quality, attribution, privacy, and handoff in CclawCore.
...
- If identity-like context is unavoidable, use CclawCore-scoped roles/labels only (e.g., `CclawCoreAgent`, `CclawCoreOperator`, `cclawcore_user`).
- Recommended identity-safe naming palette:
    - actor labels: `CclawCoreAgent`, `CclawCoreOperator`, `CclawCoreMaintainer`, `cclawcore_user`
    - service/runtime labels: `cclawcore_bot`, `cclawcore_service`, `cclawcore_runtime`, `cclawcore_node`
    - environment labels: `cclawcore_project`, `cclawcore_workspace`, `cclawcore_channel`

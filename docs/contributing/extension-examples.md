...
CclawCore's architecture is trait-driven and modular.
...
```rust
// In your crate: use cclawcore::tools::traits::{Tool, ToolResult};
...
Channels let CclawCore communicate through any messaging platform.
...
```rust
// In your crate: use cclawcore::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects CclawCore to a different model API.
...
```rust
// In your crate: use cclawcore::providers::traits::Provider;
...
```rust
// In your crate: use cclawcore::memory::traits::{Memory, MemoryEntry, MemoryCategory};

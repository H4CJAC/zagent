# CclawCore Architecture Diagrams

This document provides visual representations of CclawCore's architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways CclawCore can be run:**

```mermaid
flowchart TD
    Start[cclawcore CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[cclawcore daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[CclawCore Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>CCLAWCORE_* env vars]
...
*Generated for CclawCore v0.1.0 - Architecture Documentation*

# Tài liệu tham khảo Providers — CclawCore
...
3. Biến môi trường dự phòng chung: `CCLAWCORE_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, CclawCore gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, CclawCore trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `cclawcore models refresh --provider nvidia`

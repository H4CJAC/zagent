...
Cách cài đặt và khởi tạo CclawCore nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài CclawCore), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image CclawCore cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.cclawcore-docker`.

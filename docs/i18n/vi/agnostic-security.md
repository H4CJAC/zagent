...
|---------|-----------|--------------|--------|
| **CclawCore cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | CclawCore (cơ bản) | CclawCore (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, CclawCore chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của CclawCore: hoán đổi bất kỳ thứ gì

...
| 二进制大小 | ~3-4MB | `ls -lh target/release/cclawcore` |
| 健康检查 | <5s | `time cclawcore channel doctor` |
| 首次响应 | <3s | Telegram 中手动测试 |
| 消息拆分 | <50ms | 检查调试日志 |
| 内存使用 | <10MB | `ps aux \| grep cclawcore` |
...
- Issue：<https://github.com/cclawcore-labs/cclawcore/issues>

...
const SNAPSHOT_HEADER: &str = "# 🧠 CclawCore Memory Snapshot\n\n\
    > Auto-generated by CclawCore. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 CclawCore Memory Snapshot

> Auto-generated by CclawCore.
...
I am CclawCore, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 CclawCore Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);

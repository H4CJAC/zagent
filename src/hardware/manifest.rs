//! Plugin manifest — `~/.cclawcore/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how CclawCore spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, CclawCore will prefer the named transport kind

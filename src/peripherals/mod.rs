...
/// Handle `cclawcore peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: cclawcore peripheral add <board> <path>");
                println!("  Example: cclawcore peripheral add nucleo-f401re /dev/ttyACM0");
                println!();

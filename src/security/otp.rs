...
const OTP_ISSUER: &str = "CclawCore";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(cclawcore_dir);
...
pub fn secret_file_path(cclawcore_dir: &Path) -> PathBuf {
    cclawcore_dir.join(OTP_SECRET_FILE)
}

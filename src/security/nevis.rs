//! Nevis IAM authentication provider for CclawCore.
//!
...
//! roles to CclawCore tool permissions via [`super::iam_policy::IamPolicy`].
...
mod tests {
    ...
    fn nevis_identity_serde_roundtrip() {
        ...
        assert_eq!(parsed.user_id, "cclawcore_user");

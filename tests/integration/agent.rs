...
//!
//! Ref: https://github.com/cclawcore-labs/cclawcore/issues/618 (item 6)
...
use cclawcore::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: cclawcore"));

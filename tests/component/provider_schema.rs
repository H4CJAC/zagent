...
use cclawcore::providers::compatible::AuthStyle;
use cclawcore::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use cclawcore::providers::compatible::OpenAiCompatibleProvider;

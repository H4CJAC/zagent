...
use cclawcore::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use cclawcore::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = cclawcore::providers::ProviderRuntimeOptions::default();

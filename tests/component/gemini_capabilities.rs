...
use cclawcore::providers::create_provider_with_url;
use cclawcore::providers::traits::Provider;
...
fn gemini_convert_tools_returns_prompt_guided() {
    use cclawcore::providers::traits::ToolsPayload;
    use cclawcore::tools::traits::ToolSpec;

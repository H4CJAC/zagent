# CclawCore ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for CclawCore edge scenarios on ESP32.
...
3. Connect UI state with CclawCore edge/runtime messaging
...
- [CclawCore Hardware Design](../../docs/hardware/hardware-peripherals-design.md)

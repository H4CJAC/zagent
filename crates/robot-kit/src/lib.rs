//! # CclawCore Robot Kit
//!
//! A standalone robotics toolkit that integrates with CclawCore for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  CclawCore AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use cclawcore_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of CclawCore. It defines its own
//! `Tool` trait that is compatible with CclawCore's but doesn't require it.
//!
//! ## Safety
//!

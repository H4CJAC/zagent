//! HTTP client for communicating with the CclawCore gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://cclawcore.example.com:9999", None);
        assert_eq!(client.base_url, "https://cclawcore.example.com:9999");
    }
